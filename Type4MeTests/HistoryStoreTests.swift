...
final class HistoryStoreTests: XCTestCase {
    ...
    func testUsageBreakdownGroupsByProviderAndPeriods() async {
        ...
        XCTAssertEqual(byModel["ElevenLabs · scribe_v2_realtime"]?.recordCount, 1)
        XCTAssertEqual(byModel["ElevenLabs · scribe_v2_realtime"]?.last30DaysDuration ?? 0, 45, accuracy: 0.01)
        XCTAssertEqual(byModel["ElevenLabs · scribe_v2_realtime"]?.allTimeDuration ?? 0, 45, accuracy: 0.01)
        XCTAssertEqual(byModel["ElevenLabs"]?.recordCount, 1)
        XCTAssertEqual(byModel["ElevenLabs"]?.last30DaysDuration ?? 0, 0, accuracy: 0.01)
        XCTAssertEqual(byModel["ElevenLabs"]?.allTimeDuration ?? 0, 75, accuracy: 0.01)
