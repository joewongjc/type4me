...
**[下载 Type4Me v1.2.3](https://github.com/joewongjc/type4me/releases/tag/v1.2.3)** (macOS 14+)
...
欢迎共建接入其他厂商的模型，目前已经接入火山引擎、Deepgram 和百度智能云实时识别。
...
下载 [Type4Me-v1.2.3.dmg](https://github.com/joewongjc/type4me/releases/download/v1.2.3/Type4Me-v1.2.3.dmg)，拖入 Applications 即可使用。仅支持云端识别引擎。
...
目前已经完成了 **火山引擎（Volcengine）**、**Deepgram** 和 **百度智能云** 的 ASR 适配。项目架构还预留了其他主流云厂商的接口定义（OpenAI Whisper、Google、AWS、Azure、阿里云、腾讯云、讯飞等），欢迎继续补齐客户端实现。
